...
1.I started with creating a signature document - vec2dsmall.fsi, containg the description of :1) summary, 2) functions, 3) parametes, 4) type of input and type of output (e.g. int or float).
...
7. Consider my Black-box test and the comments on the erronous output in the file 4i1.fsx.
