...
let input = (24764.156, 43984.7485739)
let expected = 50476.941
printfn "%5b: %A length vector (rounded) = %f" (round 3 (len input) = expected) input expected
...
let negAngleInput = ang (-2.0, -3.0)


printfn " %f: (-2.0, -3.0)  negAngleExpected before rounding" negAngleInput
